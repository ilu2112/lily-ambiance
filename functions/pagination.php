 ...
 <?php 
  function numeric_posts_pagination() {
    ...
    if ( get_previous_posts_link() ) {
      printf( '<li class="prev-page">%s</li>' . "\n", get_previous_posts_link("<i class=\"fa fa-long-arrow-left\"></i>Previous Page") );
    } else {
      printf('<li class="prev-page disabled"><a><i class="fa fa-long-arrow-left"></i>Previous Page</a></li>');
    }
    ...
    if ( get_next_posts_link() ) {
      printf( '<li class="next-page">%s</li>' . "\n", get_next_posts_link("Next Page<i class=\"fa fa-long-arrow-right\"></i>") );
    } else {
